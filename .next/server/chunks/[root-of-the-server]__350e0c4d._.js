...
async function GET(request) {
    ...
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(loginUrl);
    response.cookies.set('examination_auth_token', '', {
        httpOnly: true,
        secure: ("TURBOPACK compile-time value", "development") === 'production',
        sameSite: 'lax',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__350e0c4d._.js.map